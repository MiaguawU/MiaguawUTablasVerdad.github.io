const {agregarParentesis} = require("./funciones/AgregarParentesis");
const { Convertir } = require("./funciones/Convertir");
const { DesConvertir } = require("./funciones/DesConvertir");
const { SinParentesisArrayConOperadores } = require("./funciones/SinParentesis");
const { UltimaColumnaEnResolver } = require("./funciones/UltimaColumnaEnResolver");
const {MandarAResolverSoloC} = require("./funciones/MandarResolver");
const {GenerarColumnasDeTabla} = require("./funciones/GenerarColm");
/*let arr=[]
arr.push("(")
arr.push("p")
arr.push("AND")
